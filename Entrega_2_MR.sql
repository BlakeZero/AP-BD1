...
create table produto(
    ...
    foreign key(codigo,preco) references estoque(codigo,preco_unitario)
);
...
create table estoque(
    ...
    primary key(codigo,preco_unitario),
...
create table pedido_possui_cupomdesconto(
    npedido integer,
    id integer,
    primary key(npedido, id),

    foreign key (npedido) references pedido (numero_pedido),
    foreign key (id) references cupom_desconto (id)
);
